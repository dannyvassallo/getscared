...
```shell
git clone https://github.com/dannyvassallo/getscared.git
cd getscared
```

From the "getscared" directory, install the gems by running the following:
```shell
bundle install
```

To fire up the server while in the "getscared" directory use this command:
```shell
middleman s
```
